...
<body class="auth-page">
  <main class="auth-shell">
    ...
    <section class="auth-panel" aria-labelledby="register-title">
      ...
      <!-- Global alert (validation errors, etc.) -->
      ...
      <form action="${url.registrationAction}" method="post" class="auth-form">
        ...
        <div class="field-row">
          <div class="field">
            ...
            <input
              ...
              autofocus
              aria-invalid="<#if messagesPerField?? && messagesPerField.existsError('firstName')>true<#else>false</#if>"
            />
          ...
          <div class="field">
            ...
            <input
              ...
              aria-invalid="<#if messagesPerField?? && messagesPerField.existsError('lastName')>true<#else>false</#if>"
            />
        ...
        <div class="field">
          ...
          <input
            ...
            autocomplete="email"
            aria-invalid="<#if messagesPerField?? && messagesPerField.existsError('email')>true<#else>false</#if>"
          />
        ...
        <div class="field">
          ...
          <div class="password-wrap">
            <input
              ...
              autocomplete="new-password"
              aria-invalid="<#if messagesPerField?? && messagesPerField.existsError('password-confirm')>true<#else>false</#if>"
            />
