"""
Async Splunk HEC client — fire-and-forget; swallows all errors so a
Splunk outage never impacts the event service.
"""
import asyncio
import logging
import os
...
_HOST      = "society_event_service"
_SOURCE    = "event-service"
